...
def get_available_letters(letters_guessed):
    ...
    return letters_left
def get_hint(secret_word,lettters_guessed):
  import random
  lettters_not_guessed=[]
  for i in secret_word:
    if i not in lettters_guessed:
      if i not in lettters_not_guessed:
        lettters_not_guessed.append(i)
  return random.choice(lettters_not_guessed)
